...
with tab2:
    ...
    with left: render(comparison_chart(comparison)); render(spread_bar(comparison))
    with right: render(curve_structure_chart(jkm_forward)); render(forward_chart(ttf_forward,"ttf_forward","TTF Forward","TTF Forward Curve / Implied Curve",CYAN)); render(forward_chart(hh_forward,"hh_forward","Henry Hub Forward","Henry Hub Forward Curve","#56B870"))
